package com.example.spring_boot_jwt_nguyenngoctri.util;
...
public class JwtUtil {
    ...
    private static final String USER = "tri";
    private static final String SECRET = "hey Mr Tri the secrect length must be at least 256 bits" +
            " please no reveal!";
